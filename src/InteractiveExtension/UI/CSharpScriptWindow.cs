...
{
    public class CSharpScriptWindow : Form
    {
        ...
        private CSharpScriptService _scriptService;

        public CSharpScriptWindow(ISolution solution, ILogger logger)
        {
            _solution = solution;
            _logger = logger;
            _scriptService = solution.GetComponent<CSharpScriptService>();
            
            InitializeComponent();
            Text = "C# Script Runner";
        ...
        private void RunButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // Run the script
                var dotnetPath = _scriptService.GetDotNetPath();
